(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [405],
  {
      ...
      var o = t(5893),
        ...
        d = function (e, n) {
          var t,
            ...
            _ = function () {
              if (s && c) {
                if (!d && 0 === Math.floor(a) && 22 === Math.floor(h))
                  return (c.style.clipPath = ""), void (s.style.transform = "");
                d ? (a += 0.1 * (o - a)) : (a -= 0.1 * (a - 0));
                var e = Math.min(Math.max(h, 0), 22).toFixed(4),
                  n = (r - a).toFixed(4),
                  t = a.toFixed(4);
                c.style.clipPath = "inset("
                  .concat(e, "px ")
                  .concat(n, "px ")
                  .concat(e, "px ")
                  .concat(t, "px)");
                var i = ((-a / r) * 15).toFixed(4);
                (s.style.transform = "translate3d(".concat(i, "%, 0px, 0px)")),
            ...
            x = function () {
              !d ||
                Math.floor(h) < 0 ||
                ((h -= 0.05 * (h + 1)), requestAnimationFrame(x));
            },
            f = function () {
              d ||
                22 === Math.floor(h) ||
                ((h += 0.05 * (23 - h)), requestAnimationFrame(f));
            },
            p = function () {
              (s.style.willChange = ""),
                (l.style.willChange = ""),
            ...
            j = function () {
              (d = !1),
                ...
                window.removeEventListener("contextmenu", j),
                window.removeEventListener("mouseup", j);
            };
          m.addEventListener("mousedown", function (e) {
            e.preventDefault(),
              (i = 100 + ((c.offsetWidth - 275) / 12) * 5),
              (r = c.offsetWidth - i);
            var n = h.toFixed(4),
              s = r.toFixed(4);
            (c.style.clipPath = "inset("
              ...
              .concat(s, "px ")
              .concat(n, "px 0px)")),
              (l.style.transform = "scale3d(1.1, 1.1, 1.1)"),
              (d = !0),
              (t = e.clientX),
              (o = 0),
              (a = 0),
              window.addEventListener("mousemove", v),
              window.addEventListener("contextmenu", j),
          ...
          return (
            ...
            (0, o.jsxs)("div", {
              ...
              children: [
                ...
                (0, o.jsx)("div", { ref: x, className: h().hotspot }),
                (0, o.jsx)(m.Z, { areaRef: x, mode: m.A.DRAG }),
              ],
            })
          );
        },
      ...
      var p = function (e) {
          ...
          return (
            ...
            (0, o.jsx)("span", {
              ...
              children: (0, o.jsx)("span", { children: "\u2193" }),
            })
          );
        },
        v = t(2881),
        ...
        b = t.n(g),
        w = function () {
          var e = (0, a.useState)((0, v.r)() ? 0.46 : 1.43)[0];
          return (0, o.jsx)("section", {
            ...
            children: (0, o.jsxs)(i.ZP, {
              ...
              children: [
                ...
                (0, o.jsx)(_, { animationDelay: 1.1 }),
                (0, o.jsx)(p, { className: b().arrow, animationDelay: 1.4 }),
                (0, o.jsx)(r.ZP, {
        ...
        A = function () {
          return (0, o.jsx)("section", {
            ...
            children: (0, o.jsxs)(i.ZP, {
              ...
              children: [
                (0, o.jsx)(H.Z, {
                  children: (0, o.jsx)("h4", { children: "01/" }),
                }),
                (0, o.jsxs)("div", {
                  className: k().bio,
                  children: [
        ...
        E = function () {
          return (0, o.jsx)("section", {
            ...
            children: (0, o.jsxs)(i.ZP, {
              ...
              children: [
                (0, o.jsx)(H.Z, {
                  children: (0, o.jsx)("h4", { children: "02/" }),
                }),
                (0, o.jsx)(r.ZP, {
        ...
        T = function () {
          return (0, o.jsx)("section", {
            ...
            children: (0, o.jsxs)(i.ZP, {
              ...
              children: [
                (0, o.jsx)(H.Z, {
                  children: (0, o.jsx)("h4", { children: "03/" }),
                }),
                (0, o.jsxs)("div", {
                  className: F().hobbies,
                  children: [
                    (0, o.jsx)("h2", {
                      children: (0, o.jsx)(s.Z, { text: "Football," }),
                    }),
                    (0, o.jsx)(i.r7, {
                    ...
                    (0, o.jsx)("h2", {
                      children: (0, o.jsx)(s.Z, { text: "Gaming," }),
                    }),
                    (0, o.jsx)("h2", {
                      children: (0, o.jsx)(s.Z, { text: "Music." }),
                    }),
                  ],
                }),
                (0, o.jsx)(r.ZP, {
    ...
    5197: function (e) {
      e.exports = { underlinedLink: "UnderlinedLink_underlinedLink__oFqpm" };
    },
  },
  function (e) {
