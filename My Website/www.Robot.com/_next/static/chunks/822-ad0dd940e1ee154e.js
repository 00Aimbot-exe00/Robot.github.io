  ...
  [822],
  {
    5596: function (e, n, t) {
      ...
      var r,
        ...
        u = t.n(c);
      ((r || (r = {})).LG = "lg"),
        ((a = i || (i = {}))[(a.PARAGRAPH = 0)] = "PARAGRAPH"),
        (a[(a.HEADING = 1)] = "HEADING"),
        (a[(a.SPAN = 2)] = "SPAN");
      var l = t(4050),
        f = t.n(l);
      var d,
        ...
        var n = e.text,
          ...
          T = (0, o.jsxs)(o.Fragment, {
            children: [
              C.map(function (e, n) {
                return (0,
                o.jsxs)("span", { className: u()(g({}, f().passive, !h)), children: [e, n < C.length - 1 && " "] }, n);
              }),
              !h &&
                (0, o.jsx)("span", {
        ...
        return (
                ...
                A = function () {
                  d.forEach(function (e, r) {
                    ...
                    if (n !== a) {
                      ...
                      (n = a),
                        ((t = document.createElement("span")).style.top =
                          "".concat(a, "px")),
                    ...
                    (c.innerHTML = i.innerHTML),
                      (c.style.left = "".concat(i.offsetLeft, "px")),
                      (c.style.animationDelay = "".concat(o + 0.07 * v, "s")),
                      r === d.length - 1 &&
          ...
          v === i.HEADING
            ? (0, o.jsx)("h4", {
                ref: L,
                className: u()(
                  f().animatedLinesContainer,
                  t,
                  y,
                  g({}, f().noTextTransform, A)
                ),
                children: T,
              })
            : v === i.SPAN
          ...
          return (
            ...
            (0, a.jsx)("div", {
              ...
              className: u()(
                ...
                ((l = {}),
                m(l, d().fading, s),
                m(l, d().clicked, i && n === r.CLICK),
                m(l, d().dragging, i && n === r.DRAG),
                l)
              ),
        ...
        return x === r.BUTTON
          ? (0, a.jsx)("button", {
              ...
              children: (0, a.jsx)("span", {
                className: c()(
                  _().bigAction,
                  g,
                  ((d = {}), p(d, _().passive, !j), p(d, _().inverse, E), d)
                ),
                children: P,
              }),
            })
          : (0, a.jsx)("span", {
              ...
              className: c()(
                _().bigAction,
                g,
                ((m = {}), p(m, _().passive, !j), p(m, _().inverse, E), m)
              ),
              onClick: i,
              onMouseEnter: s,
              onMouseLeave: v,
