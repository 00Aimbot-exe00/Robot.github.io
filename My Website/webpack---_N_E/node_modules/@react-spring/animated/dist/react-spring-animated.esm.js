...
const withAnimated = (Component, host) => {
  ...
  return forwardRef((givenProps, givenRef) => {
    ...
    useLayoutEffect(() => {
      ...
      if (lastObserver) {
        each(lastObserver.deps, (dep) =>
          removeFluidObserver(dep, lastObserver)
        );
