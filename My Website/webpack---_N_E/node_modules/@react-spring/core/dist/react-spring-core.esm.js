...
const getDefaultProp = (props, key) =>
  props.default === true
    ? props[key]
    : props.default
    ? props.default[key]
        ...
        if (controllers.length) {
          ...
          each(controllers, (ctrl) => {
            each(ctrl.queue, (props) => {
              ...
              props.delay = (key) =>
                delay + callProp(memoizedDelayProp || 0, key);
            });
          });
          ref.start();
        }
...
function scheduleProps(callId, { key, props, defaultProps, state, actions }) {
  return new Promise((resolve, reject) => {
    ...
    let cancel = matchProp(
      (_props$cancel = props.cancel) != null
        ? _props$cancel
        : defaultProps == null
        ? void 0
        : defaultProps.cancel,
...
const getCombinedResult = (target, results) =>
  results.length == 1
    ? results[0]
...
const setActiveBit = (target, active) =>
  active
    ? (target[$P] |= IS_ANIMATING | HAS_ANIMATED)
    : (target[$P] &= ~IS_ANIMATING);
const setPausedBit = (target, paused) =>
  ...
  _stop(goal, cancel) {
    if (isAnimating(this)) {
      ...
      const result = cancel
        ...
        : getFinishedResult(
            this.get(),
            checkFinished(this, goal != null ? goal : anim.to)
          );
      flushCalls(this._pendingCalls, result);
