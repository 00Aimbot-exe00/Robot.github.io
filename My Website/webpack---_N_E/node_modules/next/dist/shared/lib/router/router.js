...
function resolveHref(router, href, resolveAs) {
  ...
  let base;
  let urlAsString =
    typeof href === "string" ? href : (0, _utils).formatWithValidation(href);
...
class Router {
  ...
  async change(method, url, as, options, forcedScroll) {
    ...
    if (process.env.__NEXT_I18N_SUPPORT) {
      ...
      if (process.env.__NEXT_I18N_SUPPORT) {
        ...
        if (
          !((ref = this.locales) === null || ref === void 0
            ? void 0
            : ref.includes(this.locale))
        ) {
  ...
  async _preflightRequest(options) {
    ...
    if (
      ...
      const fsPathname = (0, _normalizeTrailingSlash).removePathTrailingSlash(
        parsed.pathname
      );
      let matchedPage;
      let resolvedHref;
