    ...
    try {
      ...
      onPerfEntry = ({
        ...
        const uniqueID = `${Date.now()}-${
          Math.floor(Math.random() * (9000000000000 - 1)) + 1000000000000
        }`;
        let perfStartEntry;
        ...
        exportedReportWebVitals === null || exportedReportWebVitals === void 0
          ? void 0
...
const wrapApp = (App) => (wrappedAppProps) => {
  ...
  return /*#__PURE__*/ _react.default.createElement(
    AppContainer,
    null,
    /*#__PURE__*/ _react.default.createElement(App, Object.assign({}, appProps))
  );
};
let RSCComponent;
...
function doRender(input) {
  ...
  const isRSC =
    process.env.__NEXT_RSC && "initial" in input ? !!rsc : !!__N_RSC;
