...
function changeStateWrapper(originalChangeStateWrapper) {
  var wrapper = function (
    ...
    if (
      ...
      var tags = __assign(
        __assign(__assign({}, DEFAULT_TAGS), { method: method }),
        options
      );
    ...
    return originalChangeStateWrapper.call.apply(
      originalChangeStateWrapper,
      __spread([this, method, url, as, options], args)
    );
  };
  return wrapper;
}
