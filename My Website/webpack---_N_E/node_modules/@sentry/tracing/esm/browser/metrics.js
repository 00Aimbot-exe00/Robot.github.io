...
var MetricsInstrumentation = /** @class */ (function () {
  ...
  MetricsInstrumentation.prototype.addPerformanceEntries = function (
    transaction
  ) {
    var _this = this;
    if (
    ...
    global.performance
      ...
      .forEach(function (entry) {
        ...
        switch (entry.entryType) {
          ...
          case "paint":
          case "measure": {
            var startTimestamp = addMeasureSpans(
              transaction,
              entry,
              startTime,
              duration,
    ...
    if (transaction.op === "pageload") {
      ...
      ["fcp", "fp", "lcp"].forEach(function (name) {
        if (
          !_this._measurements[name] ||
          timeOrigin_1 >= transaction.startTimestamp
        ) {
          return;
        }
      ...
      if (this._measurements["mark.fid"] && this._measurements["fid"]) {
        ...
        _startChild(transaction, {
          ...
          endTimestamp:
            ...
            msToSec(this._measurements["fid"].value),
          op: "web.vitals",
...
function addPerformanceNavigationTiming(
  ...
  _startChild(transaction, {
    op: "browser",
    description:
      description !== null && description !== void 0 ? description : event,
...
export function _startChild(transaction, _a) {
  ...
  return transaction.startChild(
    __assign({ startTimestamp: startTimestamp }, ctx)
  );
}
/**
