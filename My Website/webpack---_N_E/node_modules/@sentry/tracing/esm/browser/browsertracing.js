...
var BrowserTracing = /** @class */ (function () {
  function BrowserTracing(_options) {
    ...
    this.options = __assign(
      __assign(__assign({}, DEFAULT_BROWSER_TRACING_OPTIONS), _options),
      { tracingOrigins: tracingOrigins }
    );
    var _metricOptions = this.options._metricOptions;
    this._metrics = new MetricsInstrumentation(
      _metricOptions && _metricOptions._reportAllChanges
    );
  }
  /**
   * @inheritDoc
  ...
  BrowserTracing.prototype._createRouteTransaction = function (context) {
    ...
    var parentContextFromHeader =
      context.op === "pageload" ? getHeaderContext() : undefined;
    var expandedContext = __assign(
      __assign(__assign({}, context), parentContextFromHeader),
      { trimEnd: true }
    );
    var modifiedContext =
    ...
    var finalContext =
      modifiedContext === undefined
        ? __assign(__assign({}, expandedContext), { sampled: false })
        : modifiedContext;
    ...
    idleTransaction.registerBeforeFinishCallback(function (
      transaction,
      endTimestamp
    ) {
...
export function getMetaContent(metaName) {
  var el = getGlobalObject().document.querySelector(
    "meta[name=" + metaName + "]"
  );
